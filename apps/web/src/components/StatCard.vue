...
<template>
  <div
    class="p-4 rounded-xl border transition-[border-color,background-color,box-shadow] duration-fast relative overflow-hidden bg-surface hover:border-border-strong group"
    :class="[
      color === 'cyan'
