...
| M5 自动化 / PWA 运行时启用 / AI / 收尾 | 🔄 进行中（AI 润色升级完成） | — |
| M6 版本一致性对比与发布备份（R19） | ✅ 完成（core 单测 + API E2E 全通过） | 2026-08-13 |
| M7 备份恢复（R19 低优先级，远期） | ⏸ 暂缓 | — |
| R21 AI 多供应商体系与凭据安全管理 | ✅ 完成（6 预设 + write-only 凭据 + 润色升级） | 2026-08-17 |
| R22 仓库内 Git 面板与 AI 辅助提交/解读 | ✅ 完成（状态/暂存/提交/推送/拉取 + Conventional Commits + 解读） | 2026-08-17 |
